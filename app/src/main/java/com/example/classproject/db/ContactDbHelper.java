...
public class ContactDbHelper {
    ...
    public  Contact getContact(int id){
        ...
        Cursor cursor =  db.query(DatabaseHelper.TABLE_CONTACT,
                new String[]{"id","name","phone number"},"id=?",
    ...
    public int updateContact(Contact contact){
        ...
        return db.update(DatabaseHelper.TABLE_CONTACT, val, "id = ?", new String[]{String.valueOf(contact.getId())});
    }

    public void deleteContact(Contact contact){
        SQLiteDatabase db = dbHelper.getWritableDatabase();
        db.delete(DatabaseHelper.TABLE_CONTACT,"id = ?",new String[]{String.valueOf(contact.getId())});
        db.close();
    }
}
